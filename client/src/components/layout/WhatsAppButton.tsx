...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/40 hover:scale-110 transition-transform">
        <svg
          viewBox="0 0 24 24"
